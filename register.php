...
<title>Door To Door Deliveries </title>
...
<div id="myModal" data-keyboard="false" data-backdrop="static" style="height: 600px;">
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-header">
                ...
                <h4 class="modal-title"><br>Delivery site.<br>Register A Client</h4>
            ...
            <div class="modal-body">
                ...
                <form action=registered.php method=post>
                    <input size=25 name="email" placeholder="Client email">
                    ...
                    <input size=25 name="a" placeholder="Time differnce e.g 8"><br><br><br>
